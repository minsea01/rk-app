...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-dirs", nargs="+", required=True, help="输入数据集目录")
    parser.add_argument("--output-dir", required=True, help="输出数据集目录")
    parser.add_argument("--min-samples-per-class", type=int, default=300, help="每类最小样本数")
