...
graph TD
    ...
    H --> I[ONNX转RKNN]
    I --> |convert_onnx_to_rknn.py<br/>--do-quant| J[RKNN模型<br/>best_person_aug_416_norm_int8.rknn]
    J --> K[PC模拟器验证]
...
```mermaid
graph TD
    A[RKNN模型<br/>best_person_aug_416_norm_int8.rknn] --> B{部署模式选择}
...
| RKNN NPU | RK3588 | 416×416 | 约19-23ms | 40+ |
| RKNN NPU | RK3588 | 640×640 | 需按实际模型复测 | - |
...
- **技术指南**: `docs/docs/`
- **自动化**: `scripts/` 下的部署、训练、转换与验证脚本

---

**项目状态**: 主流程已完成，持续补充验收证据
**文档版本**: v1.0
