...
class TestHTTPPostMain:
    ...
    def test_sends_utf8_encoded_data(self):
        ...
        test_args = ["http_post.py", "--url", "http://localhost:8000", "--file", str(json_file)]
...
class TestHTTPPostEdgeCases:
    ...
    def test_handles_empty_json_file(self):
        ...
        test_args = ["http_post.py", "--url", "http://localhost:8000", "--file", str(empty_file)]
    ...
    def test_handles_nested_json_structures(self):
        ...
        nested_data = {
            "level1": {"level2": {"level3": {"level4": {"data": [1, 2, 3, {"nested": "value"}]}}}}
        }
